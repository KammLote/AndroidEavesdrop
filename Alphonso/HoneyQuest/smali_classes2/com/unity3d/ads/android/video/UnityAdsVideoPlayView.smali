...
.method private createView()V
    ...
    sget v5, Lcom/unity3d/ads/android/R$layout;->unityads_view_video_play:I
    ...
    iput-object v5, p0, Lcom/unity3d/ads/android/video/UnityAdsVideoPlayView;->_layout:Landroid/widget/RelativeLayout;
    ...
    .line 229
    iput-boolean v7, p0, Lcom/unity3d/ads/android/video/UnityAdsVideoPlayView;->_muted:Z

    .line 232
    :cond_0
    iget-object v5, p0, Lcom/unity3d/ads/android/video/UnityAdsVideoPlayView;->_layout:Landroid/widget/RelativeLayout;

    sget v6, Lcom/unity3d/ads/android/R$id;->unityAdsVideoView:I

    invoke-virtual {v5, v6}, Landroid/widget/RelativeLayout;->findViewById(I)Landroid/view/View;

    move-result-object v5

    check-cast v5, Lcom/unity3d/ads/android/video/UnityAdsVideoView;

    iput-object v5, p0, Lcom/unity3d/ads/android/video/UnityAdsVideoPlayView;->_videoView:Lcom/unity3d/ads/android/video/UnityAdsVideoView;

    .line 233
    iget-object v5, p0, Lcom/unity3d/ads/android/video/UnityAdsVideoPlayView;->_videoView:Lcom/unity3d/ads/android/video/UnityAdsVideoView;

    invoke-virtual {v5, v7}, Lcom/unity3d/ads/android/video/UnityAdsVideoView;->setClickable(Z)V

    .line 234
    iget-object v5, p0, Lcom/unity3d/ads/android/video/UnityAdsVideoPlayView;->_videoView:Lcom/unity3d/ads/android/video/UnityAdsVideoView;

    new-instance v6, Lcom/unity3d/ads/android/video/UnityAdsVideoPlayView$4;

    invoke-direct {v6, p0}, Lcom/unity3d/ads/android/video/UnityAdsVideoPlayView$4;-><init>(Lcom/unity3d/ads/android/video/UnityAdsVideoPlayView;)V

    invoke-virtual {v5, v6}, Lcom/unity3d/ads/android/video/UnityAdsVideoView;->setOnCompletionListener(Landroid/media/MediaPlayer$OnCompletionListener;)V

    .line 240
    iget-object v5, p0, Lcom/unity3d/ads/android/video/UnityAdsVideoPlayView;->_videoView:Lcom/unity3d/ads/android/video/UnityAdsVideoView;

    new-instance v6, Lcom/unity3d/ads/android/video/UnityAdsVideoPlayView$5;

    invoke-direct {v6, p0}, Lcom/unity3d/ads/android/video/UnityAdsVideoPlayView$5;-><init>(Lcom/unity3d/ads/android/video/UnityAdsVideoPlayView;)V

    invoke-virtual {v5, v6}, Lcom/unity3d/ads/android/video/UnityAdsVideoView;->setOnPreparedListener(Landroid/media/MediaPlayer$OnPreparedListener;)V

    .line 255
    iget-object v5, p0, Lcom/unity3d/ads/android/video/UnityAdsVideoPlayView;->_layout:Landroid/widget/RelativeLayout;

    sget v6, Lcom/unity3d/ads/android/R$id;->unityAdsVideoBufferingText:I
    ...
    iput-object v5, p0, Lcom/unity3d/ads/android/video/UnityAdsVideoPlayView;->_bufferingText:Landroid/widget/TextView;

    .line 256
    iget-object v5, p0, Lcom/unity3d/ads/android/video/UnityAdsVideoPlayView;->_layout:Landroid/widget/RelativeLayout;

    sget v6, Lcom/unity3d/ads/android/R$id;->unityAdsVideoCountDown:I
    ...
    iput-object v5, p0, Lcom/unity3d/ads/android/video/UnityAdsVideoPlayView;->_countDownText:Landroid/widget/LinearLayout;

    .line 257
    iget-object v5, p0, Lcom/unity3d/ads/android/video/UnityAdsVideoPlayView;->_layout:Landroid/widget/RelativeLayout;

    sget v6, Lcom/unity3d/ads/android/R$id;->unityAdsVideoTimeLeftText:I
    ...
    iput-object v5, p0, Lcom/unity3d/ads/android/video/UnityAdsVideoPlayView;->_timeLeftInSecondsText:Landroid/widget/TextView;

    .line 258
    iget-object v5, p0, Lcom/unity3d/ads/android/video/UnityAdsVideoPlayView;->_timeLeftInSecondsText:Landroid/widget/TextView;

    sget v6, Lcom/unity3d/ads/android/R$string;->unityads_default_video_length_text:I
    ...
    sget v6, Lcom/unity3d/ads/android/R$id;->unityAdsVideoSkipText:I
    ...
    iput-object v5, p0, Lcom/unity3d/ads/android/video/UnityAdsVideoPlayView;->_skipTextView:Landroid/widget/TextView;

    .line 260
    new-instance v5, Lcom/unity3d/ads/android/view/UnityAdsMuteVideoButton;

    invoke-virtual {p0}, Lcom/unity3d/ads/android/video/UnityAdsVideoPlayView;->getContext()Landroid/content/Context;

    move-result-object v6

    invoke-direct {v5, v6}, Lcom/unity3d/ads/android/view/UnityAdsMuteVideoButton;-><init>(Landroid/content/Context;)V

    iput-object v5, p0, Lcom/unity3d/ads/android/video/UnityAdsVideoPlayView;->_muteButton:Lcom/unity3d/ads/android/view/UnityAdsMuteVideoButton;

    .line 261
    iget-object v6, p0, Lcom/unity3d/ads/android/video/UnityAdsVideoPlayView;->_muteButton:Lcom/unity3d/ads/android/view/UnityAdsMuteVideoButton;

    iget-object v5, p0, Lcom/unity3d/ads/android/video/UnityAdsVideoPlayView;->_layout:Landroid/widget/RelativeLayout;

    sget v7, Lcom/unity3d/ads/android/R$id;->unityAdsAudioToggleView:I
    ...
    invoke-virtual {v6, v5}, Lcom/unity3d/ads/android/view/UnityAdsMuteVideoButton;->setLayout(Landroid/widget/RelativeLayout;)V

    .line 263
    iget-boolean v5, p0, Lcom/unity3d/ads/android/video/UnityAdsVideoPlayView;->_muted:Z

    if-eqz v5, :cond_1

    .line 264
    iget-object v5, p0, Lcom/unity3d/ads/android/video/UnityAdsVideoPlayView;->_muteButton:Lcom/unity3d/ads/android/view/UnityAdsMuteVideoButton;

    sget-object v6, Lcom/unity3d/ads/android/view/UnityAdsMuteVideoButton$UnityAdsMuteVideoButtonState;->Muted:Lcom/unity3d/ads/android/view/UnityAdsMuteVideoButton$UnityAdsMuteVideoButtonState;

    invoke-virtual {v5, v6}, Lcom/unity3d/ads/android/view/UnityAdsMuteVideoButton;->setState(Lcom/unity3d/ads/android/view/UnityAdsMuteVideoButton$UnityAdsMuteVideoButtonState;)V

    .line 267
    :cond_1
    iget-object v5, p0, Lcom/unity3d/ads/android/video/UnityAdsVideoPlayView;->_layout:Landroid/widget/RelativeLayout;

    sget v6, Lcom/unity3d/ads/android/R$id;->unityAdsAudioToggleView:I

    invoke-virtual {v5, v6}, Landroid/widget/RelativeLayout;->findViewById(I)Landroid/view/View;

    move-result-object v5

    new-instance v6, Lcom/unity3d/ads/android/video/UnityAdsVideoPlayView$6;

    invoke-direct {v6, p0}, Lcom/unity3d/ads/android/video/UnityAdsVideoPlayView$6;-><init>(Lcom/unity3d/ads/android/video/UnityAdsVideoPlayView;)V

    invoke-virtual {v5, v6}, Landroid/view/View;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    .line 286
    sget-object v5, Lcom/unity3d/ads/android/properties/UnityAdsProperties;->UNITY_DEVELOPER_INTERNAL_TEST:Ljava/lang/Boolean;
    ...
    .line 288
    .local v2, "stagingLayout":Landroid/widget/RelativeLayout;
    new-instance v3, Landroid/widget/RelativeLayout$LayoutParams;

    invoke-direct {v3, v8, v8}, Landroid/widget/RelativeLayout$LayoutParams;-><init>(II)V

    .line 289
    .local v3, "stagingParams":Landroid/widget/RelativeLayout$LayoutParams;
    const/16 v5, 0xe
    ...
    .line 294
    .local v4, "stagingText":Landroid/widget/TextView;
    ...
    .line 296
    const-string v5, "INTERNAL UNITY TEST BUILD\nDO NOT USE IN PRODUCTION"
    ...
    .line 299
    invoke-virtual {p0, v2}, Lcom/unity3d/ads/android/video/UnityAdsVideoPlayView;->addView(Landroid/view/View;)V

    .line 302
    .end local v2    # "stagingLayout":Landroid/widget/RelativeLayout;
    .end local v3    # "stagingParams":Landroid/widget/RelativeLayout$LayoutParams;
    .end local v4    # "stagingText":Landroid/widget/TextView;
    :cond_2
    invoke-direct {p0}, Lcom/unity3d/ads/android/video/UnityAdsVideoPlayView;->hasSkipDuration()Z
    ...
    invoke-direct {p0, v6, v7}, Lcom/unity3d/ads/android/video/UnityAdsVideoPlayView;->updateSkipText(J)V

    .line 306
    :cond_3
    new-instance v5, Lcom/unity3d/ads/android/video/UnityAdsVideoPlayView$7;

    invoke-direct {v5, p0}, Lcom/unity3d/ads/android/video/UnityAdsVideoPlayView$7;-><init>(Lcom/unity3d/ads/android/video/UnityAdsVideoPlayView;)V

    invoke-virtual {p0, v5}, Lcom/unity3d/ads/android/video/UnityAdsVideoPlayView;->setOnClickListener(Landroid/view/View$OnClickListener;)V
...
.method private storeVolume()V
    ...
    .line 181
    sget-object v4, Lcom/unity3d/ads/android/properties/UnityAdsProperties;->APPLICATION_CONTEXT:Landroid/content/Context;
...
.method public playVideo(Ljava/lang/String;Z)V
    ...
    .line 83
    :cond_1
    iput-boolean v5, p0, Lcom/unity3d/ads/android/video/UnityAdsVideoPlayView;->_videoPlayheadPrepared:Z
    ...
    const-string v4, "Playing video from: "
    ...
    new-instance v4, Lcom/unity3d/ads/android/video/UnityAdsVideoPlayView$1;

    invoke-direct {v4, p0}, Lcom/unity3d/ads/android/video/UnityAdsVideoPlayView$1;-><init>(Lcom/unity3d/ads/android/video/UnityAdsVideoPlayView;)V

    invoke-virtual {v3, v4}, Lcom/unity3d/ads/android/video/UnityAdsVideoView;->setOnErrorListener(Landroid/media/MediaPlayer$OnErrorListener;)V
    ...
    const-string v3, "COULD NOT SET FILE READABLE"
    ...
    invoke-virtual {v3, p1}, Lcom/unity3d/ads/android/video/UnityAdsVideoView;->setVideoPath(Ljava/lang/String;)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0

    .line 111
    iget-boolean v3, p0, Lcom/unity3d/ads/android/video/UnityAdsVideoPlayView;->_videoPlaybackErrors:Z
    ...
    const-string v3, "For some reason the device failed to play the video, a crash was prevented."
