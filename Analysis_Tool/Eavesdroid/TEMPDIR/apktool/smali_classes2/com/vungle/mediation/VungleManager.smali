...
.method public onAdEnd(ZZ)V
    ...
    .prologue
    .line 71
    iget-object v1, p0, Lcom/vungle/mediation/VungleManager;->listeners:Ljava/util/Map;
    ...
    :try_start_0
    iget-object v1, p0, Lcom/vungle/mediation/VungleManager;->currentPlayId:Ljava/lang/String;
    ...
    invoke-virtual {v1, p1, p2}, Lcom/vungle/mediation/VungleListener;->onAdEnd(ZZ)V
    :try_end_0
...
.method public onAdPlayableChanged(Z)V
    ...
    invoke-virtual {v1}, Lcom/vungle/mediation/VungleListener;->isWaitingForAd()Z
    ...
    invoke-virtual {v1}, Lcom/vungle/mediation/VungleListener;->clearWaitForAd()V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method public onAdStart()V
    ...
    invoke-virtual {v1}, Lcom/vungle/mediation/VungleListener;->onAdStart()V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
